...
// whenever a file contains a component we captilize that file name
function App() {
  
  // componenet must always contain a return which houses the html
...
// whenever we only have 1 component in a file we can call it a default component
